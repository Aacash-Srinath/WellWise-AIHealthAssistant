...
import 'prescription_uploader_copy_model.dart';
export 'prescription_uploader_copy_model.dart';

class PrescriptionUploaderCopyWidget extends StatefulWidget {
  const PrescriptionUploaderCopyWidget({super.key});

  @override
  State<PrescriptionUploaderCopyWidget> createState() =>
      _PrescriptionUploaderCopyWidgetState();
}

class _PrescriptionUploaderCopyWidgetState
    extends State<PrescriptionUploaderCopyWidget> {
  late PrescriptionUploaderCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrescriptionUploaderCopyModel());
  }
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await geminiTextFromImage(
                              ...
                              safeSetState(
                                  () => _model.mealPlan = generatedText);
                            });

                            await currentUserReference!
                                .update(createUsersRecordData(
                              prescriptionData: _model.mealPlan,
                            ));
